...
def stripe_catalog_task(generated_at: str) -> dict[str, str]:
    return {
        ...
        "evidence_url": "",
        "completed_at": "",
        "next_action": "Switch the local Stripe CLI to the TinyZKP account, confirm billing/stripe_account_context_check.py passes, then run bash billing/setup_stripe_products.sh --stripe-cli --stripe-bin /opt/homebrew/bin/stripe --push-cloudflare with write-capable live access and rerun the strict revenue-ops audit.",
