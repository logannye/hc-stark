...
REQUIRED = (
    ...
    "sandbox_job",
    "total_scratch_bytes",
    "beta_operational_incidents",
    "beta_one_open_operational_incident",
    "beta_invariant_acknowledgements",
    "beta_infrastructure_health",
    "beta_support_minutes",
    "beta_business_activation",
    "beta_viability_reports",
    "beta_workers",
