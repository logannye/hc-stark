...
require_contains site/research.html "What is live now, and what remains roadmap work" "research page separates live scope from roadmap work"

require_contains site/security.html "Template discovery uses three lifecycle values" "security page documents template lifecycle"
require_contains site/security.html "audit_gated" "security page names audit-gated lifecycle"
...
require_contains site/docs.html "Security &amp; Audit Status" "docs include security status section"
require_contains site/docs.html "When Not to Use TinyZKP" "docs include fit-filter guidance"
