# TinyZKP MCP Submission: mcp.so

Status: `submitted`
Kind: `mcp_directory`
Submission URL: https://mcp.so/submit
Current listing: https://github.com/chatmcp/mcpso/issues/2916
...
Website / CTA: https://tinyzkp.com/signup?source=mcp_so&medium=mcp_directory&platform=mcp_so&intent=mcp_install
...
https://tinyzkp.com/signup?source=mcp_so&medium=mcp_directory&platform=mcp_so&intent=mcp_install
