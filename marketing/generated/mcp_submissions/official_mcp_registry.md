# TinyZKP MCP Submission: Official MCP Registry

Status: `active`
Kind: `mcp_registry`
Submission URL: https://modelcontextprotocol.io/registry/quickstart
Current listing: https://registry.modelcontextprotocol.io/v0.1/servers/io.github.logannye%2Ftinyzkp/versions/latest
...
Website / CTA: https://tinyzkp.com/signup?source=official_mcp_registry&medium=mcp_directory&platform=modelcontextprotocol&intent=mcp_install
...
https://tinyzkp.com/signup?source=official_mcp_registry&medium=mcp_directory&platform=modelcontextprotocol&intent=mcp_install
...
io.github.logannye/tinyzkp, https://mcp.tinyzkp.com
