# TinyZKP MCP Submission: Smithery

Status: `active`
Kind: `mcp_directory`
Submission URL: https://smithery.ai/new
Current listing: https://smithery.ai/servers/logan/tinyzkp-mcp
...
Website / CTA: https://tinyzkp.com/signup?source=smithery_mcp&medium=mcp_directory&platform=smithery&intent=mcp_install
...
https://tinyzkp.com/signup?source=smithery_mcp&medium=mcp_directory&platform=smithery&intent=mcp_install
